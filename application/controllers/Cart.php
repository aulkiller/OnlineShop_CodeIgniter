...
class CART extends CI_Controller {
    ...
    public function removeFromCart() {
        ...
        if ($succ) $message = '<div class="alert alert-success" style="margin-top:10px" role="alert"> Item telah dihapus dari keranjang anda. </div>';
        else $message = '<div class="alert alert-danger" style="margin-top:10px" role="alert"> Gagal menghapus item dari keranjang anda. </div>';       
    ...
    public function checkout() {
        ...
        if ($count == 0) {
            $message = '<div class="alert alert-danger" style="margin-top:10px" role="alert"> Tidak ada barang di keranjang anda. </div>'; 
            $this->session->set_flashdata('msg', $message);
            redirect('user/your_cart');
        } else {
            $this->cart_model->buyCart($cartid);
            $message = '<div class="alert alert-success" style="margin-top:10px" role="alert"> Anda telah membeli barang dari keranjang anda. </div>'; 
            $this->session->set_flashdata('msg', $message);
            redirect('user/your_cart');
        }
    }
